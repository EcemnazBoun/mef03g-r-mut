...
## Group Members
* Atahan Şenşatar [Linkedin]()
* Batuhan [Linkedin]()
* Cem Özçilingir [Linkedin]()
* Nilay Kamar [Linkedin](https://www.linkedin.com/in/kamarnilay/)
* Tibet Erdoğan [Linkedin]()
...
### 7.2 Inflation vs. Interest Rates
...
### 7.3 Technology Exports vs. Interest Rate

#### 7.3.1 Dot Plot the techonology data and see what it has
...
#### 7.3.2 Analysis of technology indicators
...
#### 7.3.3 Compare between High tech and the other indicators
...
#### 7.3.4 Join two tables to analyze
...
#### 7.3.5 Conclusion of techonolgy export and interest rate relationship
...
### 7.4 Relationship Between Interest Rate And Foreign Trade
...
#### 7.4.1 Graph of exports (USD in billions)
...
#### 7.4.2 Graph of imports (USD in billions)
...
#### 7.4.3 Graph of foreign trade balance (USD in billions)
...
#### 7.4.4 Comparison of interest rate and current account deficit
