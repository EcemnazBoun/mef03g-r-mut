...
The graph shows the relationship between interest rate and current account deficit. Except for some periods, while one moves upwards, the other moves downwards.
...
Interest rate and current account deficit mostly moves in the opposite direction. Except for some periods, while one moves upwards, the other moves downwards.
